...
- [pmm-0.5.5-windows-amd64.zip](/download/pmm-0.5.5-windows-amd64.zip) — Windows 免安装
- [pmm_0.5.5_amd64.deb](/download/pmm_0.5.5_amd64.deb) — Debian/Ubuntu
- [pmm-0.5.5.x86_64.rpm](/download/pmm-0.5.5.x86_64.rpm) — CentOS/RHEL
- [pmm-0.5.5.apk](/download/pmm-0.5.5.apk) — Alpine
- [pmm-0.5.5.pkg.tar.zst](/download/pmm-0.5.5.pkg.tar.zst) — Arch

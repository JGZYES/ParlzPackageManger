...
```bash
# PowerShell
Invoke-WebRequest https://pmm.parlz.com/download/pmm-0.5.4-windows-amd64.zip -OutFile pmm.zip
...
```bash
curl -L -o pmm.deb https://pmm.parlz.com/download/pmm_0.5.4_amd64.deb
...
```bash
curl -L -o pmm.rpm https://pmm.parlz.com/download/pmm-0.5.4.x86_64.rpm

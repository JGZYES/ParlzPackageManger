...
```bash
# PowerShell
Invoke-WebRequest https://pmm.parlz.com/download/pmm-0.3.9-windows-amd64.zip -OutFile pmm.zip
...
```bash
curl -L -o pmm.deb https://pmm.parlz.com/download/pmm_0.3.9_amd64.deb
...
```bash
curl -L -o pmm.rpm https://pmm.parlz.com/download/pmm-0.3.9.x86_64.rpm
